                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('additional_info') is-invalid @enderror" 
                                      ...
                                      rows="3" 
                                      placeholder="Additional product information...">{{ old('additional_info', $product->additional_info) }}</textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="copyright" 
                                       name="copyright" 
                                       value="{{ old('copyright', $product->copyright) }}" 
